...
<!-- 	 getting data from view to controller using @RequestParam in method parameter.
	 ...
	 same and also email ,  username ,  userpassword , isChecked should matched 
	 with the name attribute in <input> tag -->
	    
	    
		<form action="processformformodel" method="post">
			...
			<div class="form-check">
				...
				<label class="form-check-label" for="isChecked">Check me out</label>
			</div>
